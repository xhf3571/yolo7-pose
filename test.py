...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/disk/xuhaifeng/yolov7-pose/runs/train/yolov7-tiny-pose-crowdpose19/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='/home/disk/xuhaifeng/yolov7-pose/data/crowd-pose.yaml', help='*.data path')
    ...
    parser.add_argument('--name', default='YOLOv7-tiny-pose', help='save to project/name')
