...
from models.commonFromYolov7Pose import *
...
from models.backbone.pkinet import CAA
...
class IKeypoint(nn.Module):
    ...
    def __init__(self, nc=80, anchors=(), nkpt=14, ch=(), inplace=True, dw_conv_kpt=False):  # detection layer
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, DWConv, MixConv2d, Focus, ConvFocus, CrossConv, BottleneckCSP,
                 C3, C3TR, BottleneckCSPF, BottleneckCSP2, SPPCSP, SPPCSPC,CAA]:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/disk/xuhaifeng/yolov7-pose/cfg/yolov7-tiny-pose.yaml', help='model.yaml')
